 ...
 * This is modified to assume controlers files all end with "_controller.php"
 *
 * @package		CodeIgniter
	...
	function _validate_request($segments)
	{
		...
		{		
			...
			if (count($segments) > 0)
			{
				...
				{
					show_404($this->fetch_directory().$segments[0].'_controller');
				}
			}
			else
			{
